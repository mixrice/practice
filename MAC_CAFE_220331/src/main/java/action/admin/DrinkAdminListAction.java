...
public class DrinkAdminListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(a_grade == null || !a_grade.equalsIgnoreCase("Admin")) {
			...
			out.println("</script>");
			 ...
			 /**** [변경하는 내용] **************************************************************/
			 DrinkListService drinkListServiceListService = new DrinkListService();
			 ArrayList<Menu> drinkList = drinkListServiceListService.getDrinkList();
			 
		 	 request.setAttribute("menuAdminList", drinkList);
